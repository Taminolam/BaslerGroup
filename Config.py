...
MAIN_WINDOW_HEIGHT_PX = 1080

# game field size parameters, need to be same size as camera resolution!!!
FIELD_WIDTH_PX = 1800
FIELD_HEIGHT_PX = 1200

USE_CARRERA_REMOTE_CONTROL = True

LIGHTCYCLES_PERMANENTLY_DRIVING = False

COLLISION_DISTANCE_LIMIT_LIGHTCYCLES_PX = 0
COLLISION_DISTANCE_LIMIT_TRAILS_PX = 0
COLLISION_DISTANCE_LIMIT_FIELD_BOUNDARIES_PX = 0
